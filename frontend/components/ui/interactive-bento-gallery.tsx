...
const MediaItem = ({ item, className, onClick }: { item: MediaItemType, className?: string, onClick?: () => void }) => {
    ...
    return (
        <img
            ...
            className={`${className} object-cover cursor-pointer w-full h-full`} // Style the image
        ...
        <div className="container mx-auto px-2 py-8 max-w-7xl">
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-2 auto-rows-[90px]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{

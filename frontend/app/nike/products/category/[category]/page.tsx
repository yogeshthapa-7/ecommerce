...
const CategoryPage = () => {
  ...
  const genders = ['All', ...new Set(categoryProducts.map((p) => p?.gender).filter(Boolean))];
              ...
              <div className="flex gap-2 flex-wrap">
                {genders.map((gender) => (
                  <button
                    ...
                    className={`px-6 py-2 rounded-full font-bold transition-all ${selectedGender === gender

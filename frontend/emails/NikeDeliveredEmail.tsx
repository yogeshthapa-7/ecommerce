...
interface NikeDeliveredEmailProps {
    customerName: string;
    orderId: string;
    orderDate?: string;
...
export const NikeDeliveredEmail = ({
    ...
    return (
        <Html>
            ...
            <Preview>Your Nike order has been delivered - {orderId}</Preview>
            <Body style={main}>
                <Container className="email-container" style={container}>
                    <Section style={topBar}>
                        <Text style={logo}>NIKE</Text>
                        <Text style={topMeta}>Order Delivered</Text>
                    </Section>

                    <Section style={hero}>
                        <Text style={eyebrow}>Package received</Text>
                        <Heading className="email-mobile-h1" style={h1}>DELIVERED.</Heading>
                        <Text className="email-mobile-text" style={heroText}>
                            It has arrived, {customerName}. We hope your new gear fits your game.
                        </Text>
                    </Section>
                    ...
                    <Section style={messageCard}>
                        ...
                        <Text style={text}>
                            Your order #{orderId} was delivered on {deliveryDate || 'the scheduled date'}.
                    ...
                    <Section style={summaryGrid}>
                        ...
                        <Section style={summaryCell}>
                            ...
                            <Text style={orderValue}>Delivered</Text>
                        </Section>
                    </Section>
                    ...
                    <Section style={regardsCard}>
                        <Text style={regardsTitle}>Enjoy the ride.</Text>
                        <Text style={text}>
                            We appreciate you choosing Nike. We&apos;d love to hear how your gear is performing.
...
export default NikeDeliveredEmail;

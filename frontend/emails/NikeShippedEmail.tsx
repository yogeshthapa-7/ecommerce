...
interface NikeShippedEmailProps {
    customerName: string;
    orderId: string;
    orderDate?: string;
...
export const NikeShippedEmail = ({
    ...
    return (
        <Html>
            ...
            <Preview>Your Nike order is shipped - {orderId}</Preview>
            <Body style={main}>
                <Container className="email-container" style={container}>
                    <Section style={topBar}>
                        <Text style={logo}>NIKE</Text>
                        <Text style={topMeta}>Order Shipped</Text>
                    </Section>

                    <Section style={hero}>
                        <Text style={eyebrow}>On its way</Text>
                        <Heading className="email-mobile-h1" style={h1}>SHIPPED.</Heading>
                        <Text className="email-mobile-text" style={heroText}>
                            Your gear is on the move, {customerName}. Use the tracking details below to stay updated.
                        </Text>
                    </Section>
                    ...
                    <Section style={messageCard}>
                        ...
                        <Text style={text}>
                            We&apos;re happy to let you know that your order #{orderId} has been shipped
                            and is now on its way to you.
                        </Text>
                    </Section>

                    <Section style={trackingCard}>
                        <Text style={sectionTitle}>Tracking Info</Text>
                    ...
                    <Section style={summaryGrid}>
                        ...
                        <Section style={summaryCell}>
                            ...
                            <Text style={orderValue}>Shipped</Text>
                        </Section>
                    </Section>
...
export default NikeShippedEmail;

...
interface NikeCancelledEmailProps {
    customerName: string;
    orderId: string;
    orderDate?: string;
...
export const NikeCancelledEmail = ({
    ...
    return (
        <Html>
            ...
            <Preview>Your Nike order has been cancelled - {orderId}</Preview>
            <Body style={main}>
                <Container className="email-container" style={container}>
                    <Section style={topBar}>
                        <Text style={logo}>NIKE</Text>
                        <Text style={topMeta}>Order Cancelled</Text>
                    </Section>

                    <Section style={hero}>
                        <Text style={eyebrow}>Order cancelled</Text>
                        <Heading className="email-mobile-h1" style={h1}>CANCELLED.</Heading>
                        <Text className="email-mobile-text" style={heroText}>
                            Your order #{orderId} has been cancelled, {customerName}.
                            See the details below for next steps.
                        </Text>
                    </Section>
                    ...
                    <Section style={messageCard}>
                        ...
                        <Text style={text}>
                            We&apos;re sorry to inform you that your order #{orderId} has been cancelled.
                            {cancelReason ? ` Reason: ${cancelReason}.` : ''}
                        </Text>
                        {refundAmount !== undefined && refundAmount > 0 && (
                            <Text style={text}>
                                A refund of <strong>{formatMoney(refundAmount, currency)}</strong> will be processed
                                to your {refundMethod || 'original payment method'} within 5-10 business days.
                            </Text>
                        )}
                    </Section>
                    ...
                    <Section style={summaryGrid}>
                        ...
                        <Section style={summaryCell}>
                            ...
                            <Text style={orderValue}>Cancelled</Text>
                        </Section>
                    </Section>
                    ...
                    <Section style={regardsCard}>
                        <Text style={regardsTitle}>Sorry for the inconvenience.</Text>
                        <Text style={text}>
                            We apologize for any trouble this may have caused. If you have any questions
                            or would like to place a new order, please reach out to our support team or
                    ...
                    <Section style={footer}>
                        <Text style={footerText}>
                            This notification was sent for order {orderId}.
                        </Text>
                        <Text style={footerText}>
...
export default NikeCancelledEmail;
